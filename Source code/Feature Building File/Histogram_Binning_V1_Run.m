...
% for ATTAS = { '1_tatta'}
    ...
    mkdir (['C:\Users\Decrypt\Desktop\Final Result V1\Resized_Hist\' ATTA '_Hist']);

    SAVE_DIR = ['C:\Users\Decrypt\Desktop\Final Result V1\Resized_Hist\' ATTA '_Hist' '\'];
    for NUMBER_ = 1:8
        ...
        %     For index 1 to 9
            ...
            try
                ...
                for i=1 : No_ofImages - 1
                    ...
                    H = Histogram_Binning(hog, prevImg, flow);
...
% for ATTAS = { '10_utsanga'}
    ...
    for NUMBER_ = 1:8
        ...
        %     For after 10 index
            ...
            READ_CSV = strcat(FILE,'.csv');
            Nomenclature = strcat(ATTA(1:2), '_', FILE);
            SAVE_FILE = strcat(ATTA(1:2), '_', FILE, '.mat');
